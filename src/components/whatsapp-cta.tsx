...
const WHATSAPP_MESSAGE = encodeURIComponent("היי, ראיתי את הדף שלך ואשמח לשמוע על בניית דף נחיתה לעסק שלי 🙏");
          ...
          <AnimatePresence>
            {showLabel && (
              <motion.div
                ...
                exit={{ opacity: 0, x: 16 }}
                className="bg-background/90 backdrop-blur-sm border border-border/50 px-4 py-2 rounded-full text-sm font-semibold shadow-lg whitespace-nowrap"
              >
                שלח הודעה ←
              </motion.div>
            )}
